...
(function(){
  var p, STRIP_COMMENTS, ARGUMENT_NAMES, params, services, createObject, register, transform, load, object, xonom, x$;
  ...
  createObject = function(){
    ...
    func = function(){
      var ref$;
      return typeof (ref$ = this.prototype).__invoke == 'function' ? ref$.__invoke() : void 8;
    };
    return func;
  };
  register = function(name){
    ...
    services.push([name, createObject()]);
    return name;
  };
